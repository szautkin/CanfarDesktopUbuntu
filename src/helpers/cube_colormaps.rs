...
/// Magma, Plasma).
pub const NAMES: &[&str] = &[
    "Grayscale", "Inverted", "Heat", "Cool", "Viridis", "Inferno", "Magma", "Plasma",
];
...
const INFERNO_STOPS: &[(f32, f32, f32)] = &[
    (0.001462, 0.000466, 0.013866), (0.046915, 0.030324, 0.150164),
    (0.142378, 0.046242, 0.308553), (0.258234, 0.038571, 0.406485),
    (0.366529, 0.071579, 0.431994), (0.472328, 0.110547, 0.428334),
    (0.578304, 0.148039, 0.404411), (0.682656, 0.189501, 0.360757),
    (0.780517, 0.243327, 0.299523), (0.865006, 0.316822, 0.226055),
    (0.929644, 0.411479, 0.145367), (0.970919, 0.522853, 0.058367),
    (0.987622, 0.645320, 0.039886), (0.978806, 0.774545, 0.176037),
    (0.950018, 0.903409, 0.380271), (0.954529, 0.972590, 0.612366),
...
const MAGMA_STOPS: &[(f32, f32, f32)] = &[
    (0.001, 0.000, 0.014), (0.078, 0.043, 0.206), (0.232, 0.059, 0.438),
    (0.390, 0.100, 0.502), (0.550, 0.161, 0.506), (0.716, 0.215, 0.475),
    (0.868, 0.288, 0.409), (0.967, 0.440, 0.360), (0.987, 0.991, 0.749),
];

/// macOS plasma, 9 anchors (verbatim from `cubeColormapStops`).
const PLASMA_STOPS: &[(f32, f32, f32)] = &[
    (0.050, 0.030, 0.528), (0.254, 0.013, 0.615), (0.417, 0.000, 0.658),
    (0.562, 0.052, 0.641), (0.692, 0.165, 0.564), (0.798, 0.280, 0.470),
    (0.881, 0.392, 0.383), (0.949, 0.518, 0.295), (0.940, 0.975, 0.131),
];
...
pub const DEFAULT_TRANSFER: &[(f32, f32)] =
    &[(0.0, 0.0), (0.15, 0.09), (0.5, 0.42), (1.0, 1.0)];
