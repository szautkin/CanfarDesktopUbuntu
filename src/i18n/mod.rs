...
static HAND_PAIRS: &[(&str, &str)] = &[
    ...
    ("Upload {} files",                             "Téléverser {} fichiers"),
    ("{} of {} uploaded",                           "{} sur {} téléversés"),
    ("no session with id '{}' is running",          "aucune session avec l'identifiant « {} » n'est en cours"),
    ("Open session",                                "Ouvrir la session"),
    ("Renew {}",                                    "Renouveler {}"),
    ("Events for {}",                               "Événements de {}"),
    ("Delete {}",                                   "Supprimer {}"),
    ("Could not delete {}: {}",                     "Impossible de supprimer {} : {}"),
    ("{} checked · {} new · {} unusable",           "{} vérifiés · {} nouveaux · {} inutilisables"),
    ("{} task running",                             "{} tâche en cours"),
    ("{} tasks running",                            "{} tâches en cours"),
    ("{} failed",                                   "{} en échec"),
    ("Show what the app is doing",                  "Afficher ce que fait l'application"),
    ("Nothing has run yet in this session.",        "Rien n'a encore été exécuté dans cette session."),
    ("Clear finished",                              "Effacer les tâches terminées"),
    ("done",                                        "terminé"),
    ("abandoned",                                   "abandonné"),
    ...
    ("Inspect {}",                                  "Inspecter {}"),
    ("Relaunch {}",                                 "Relancer {}"),
    ("Launch session",                              "Lancer une session"),
    ("checking sign-in",                            "vérification de la connexion"),
    ("looking up the image",                        "recherche de l'image"),
    ("resolving your CANFAR account",               "résolution de votre compte CANFAR"),
    ("looking for a published manifest",            "recherche d'un manifeste publié"),
    ("staging the probe script",                    "préparation du script de sondage"),
    ("submitting a {} job",                         "soumission d'une tâche {}"),
    ("submitting {}",                               "soumission de {}"),
    ("waiting for job {}",                          "en attente de la tâche {}"),
    ("reading the job's output",                    "lecture de la sortie de la tâche"),
    ("reading the manifest",                        "lecture du manifeste"),
    ("probe",                                       "sonde"),
    ("inspector",                                   "inspecteur"),
    ("Could not inspect {}: {}",                    "Impossible d'inspecter {} : {}"),
    ("Inspect again — the image may have been rebuilt under the same tag",
     "Inspecter à nouveau — l'image a peut-être été reconstruite sous la même étiquette"),
    ("Run a probe job to list this image's packages",
    ...
    ("No images match the current filters.",        "Aucune image ne correspond aux filtres actuels."),
    ("Inspector CPU cores",                         "Cœurs CPU de l'inspecteur"),
    ("Inspector RAM (GB)",                          "RAM de l'inspecteur (Go)"),
    ("Size of the job that inspects an image; the in-target probe is always small",
     "Taille de la tâche qui inspecte une image ; la sonde interne reste toujours petite"),
    ("The inspector unpacks the whole target image — too little memory and it is killed part-way",
     "L'inspecteur décompresse l'image cible entière — avec trop peu de mémoire, il est arrêté en cours de route"),
    ...
    ("callout",                                     "légende"),
    ("text",                                        "texte"),
    ("Draw a mark on the image. Click where you mean, Shift-drag to move the image, Escape to stop.",
     "Dessiner un repère sur l'image. Cliquez à l'endroit voulu, Maj+glisser pour déplacer l'image, Échap pour arrêter."),
    ...
    ("Filter recent files",                         "Filtrer les fichiers récents"),
    ("No cubes opened yet.",                        "Aucun cube ouvert pour l'instant."),
    ("No images opened yet.",                       "Aucune image ouverte pour l'instant."),
    ...
    ("agent working",                               "agent en cours"),
    ("No AI agent has called a tool recently",      "Aucun agent IA n'a appelé d'outil récemment"),
    ("Mark colour",                                 "Couleur du repère"),
    ("Label size in pixels",                        "Taille du texte en pixels"),
    ("Bold label",                                  "Texte en gras"),
    ("Outline thickness in pixels",                 "Épaisseur du trait en pixels"),
    ...
    ("Delete this one",                             "Supprimer cet élément"),
    ("Filter marks…",                               "Filtrer les repères…"),
    ("Filter bookmarks…",                           "Filtrer les signets…"),
    ("{} keyword",                                  "{} mot-clé"),
    ("{} keywords",                                 "{} mots-clés"),
    ("{} bookmark",                                 "{} signet"),
    ("{} bookmarks",                                "{} signets"),
    ("Nothing matches that filter.",                "Aucun élément ne correspond à ce filtre."),
    ("Rename this mark",                            "Renommer ce repère"),
    ("Click a mark to edit it: drag a grip to resize, the shape to move it, then confirm.",
     "Cliquez sur un repère pour le modifier : faites glisser une poignée pour redimensionner, la forme pour la déplacer, puis confirmez."),
...
prend en compte à son prochain démarrage."),
    ...
    ("Black point, as a percentile of the pixels — 0.5 is the default",
     "Point noir, en centile des pixels — 0,5 par défaut"),
    ("Min cut",                                     "Seuil bas"),
    ("White point, as a percentile of the pixels — 99.5 is the default",
     "Point blanc, en centile des pixels — 99,5 par défaut"),
    ("Max cut",                                     "Seuil haut"),
    ("Save what you are looking at, marks and all, as a PNG or a PDF",
     "Enregistrer ce que vous voyez, repères compris, en PNG ou en PDF"),
    ("FITS image",                                  "Image FITS"),
    ("No WCS — pixel coordinates only",
     "Pas de WCS — coordonnées en pixels seulement"),
    ("DEC",                                         "DEC"),
    ("FIELD",                                       "CHAMP"),
    ("CUT LEVELS",                                  "SEUILS"),
    ("STRETCH",                                     "ÉTIREMENT"),
    ...
    ("Select an area to export. Drag a box; releasing opens the dialog.",
     "Sélectionner une zone à exporter. Tracez un cadre ; le relâchement ouvre la boîte de dialogue."),
    ("Cut levels",                                  "Seuils d’affichage"),
    ("How the black and white points are chosen",
     "Comment les points noir et blanc sont choisis"),
    ("Percentile",                                  "Centile"),
    ("ZScale",                                      "ZScale"),
    ("{} to {}{}",                                  "{} à {}{}"),
    ...
    ("Add image from registry", "Ajouter une image du registre"),
    ("Launch session", "Lancer une session"),
    ("Back to the form", "Retour au formulaire"),
    ("The session could not be started", "La session n'a pas pu être démarrée"),
    ("The batch job was not submitted", "La tâche par lots n'a pas été soumise"),
    ("{} is starting", "{} démarre"),
    ("{} submitted", "{} soumise"),
    ("Batch job \u{00B7} {}", "Tâche par lots \u{00B7} {}"),
    ("Start a new interactive session", "Démarrer une nouvelle session interactive"),
    ("Show the packages and OS found inside this image", "Afficher les paquets et le système trouvés dans cette image"),
    ("The probe found no package manager in this image.", "La sonde n'a trouvé aucun gestionnaire de paquets dans cette image."),
    ("Installed packages", "Paquets installés"),
    ("This image could not be inspected, so there is nothing to search inside it. Inspect it again from the CANFAR Images list — a rebuilt image often succeeds where an earlier attempt did not.", "Cette image n'a pas pu être inspectée, il n'y a donc rien à y chercher. Relancez l'inspection depuis la liste Images CANFAR — une image reconstruite réussit souvent là où une tentative précédente a échoué."),
    ("What the probe reported", "Ce que la sonde a signalé"),
    ("Open for the full output", "Ouvrir pour la sortie complète"),
    ("Nothing is known about what is installed in this image. Press Inspect in the CANFAR Images list to run a probe job; it takes a few minutes, and the result is cached and searchable afterwards.", "Rien n'est connu de ce qui est installé dans cette image. Appuyez sur Inspecter dans la liste Images CANFAR pour lancer une sonde ; cela prend quelques minutes, et le résultat est mis en cache puis consultable."),
    ("No package matches that.", "Aucun paquet ne correspond."),
    ("Operating system", "Système d'exploitation"),
    ("Capabilities", "Capacités"),
    ("Conda environments", "Environnements Conda"),
    ("Shells", "Interpréteurs de commandes"),
    ("Not recorded", "Non enregistré"),
    ("Inspected — date not recorded", "Inspectée — date non enregistrée"),
    ("Inspected {}", "Inspectée {}"),
    ("{} package", "{} paquet"),
    ("{} packages", "{} paquets"),
    ("{} matching, across {}", "{} correspondances, dans {}"),
    ("{} section", "{} section"),
    ("{} sections", "{} sections"),
    ("+{} more — search to narrow", "+{} de plus — cherchez pour affiner"),
    ("Remove this image from your list (it stays in the registry)", "Retirer cette image de votre liste (elle reste dans le registre)"),
    ("Search the container registry for an image the platform does not list, and add it to your own", "Chercher dans le registre de conteneurs une image que la plateforme ne liste pas, et l'ajouter aux vôtres"),
    ("Registry", "Registre"),
    ("Host", "Hôte"),
    ("Credentials", "Identifiants"),
    ("Using your saved Harbor CLI secret", "Utilisation de votre secret CLI Harbor enregistré"),
    ("Optional — public projects need none", "Facultatif — les projets publics n'en ont pas besoin"),
    ("Harbor CLI secret", "Secret CLI Harbor"),
    ("Search the registry", "Chercher dans le registre"),
    ("Images are fetched only when you search. Nothing is downloaded in the background.", "Les images ne sont récupérées que lorsque vous cherchez. Rien n'est téléchargé en arrière-plan."),
    ("Repository name, e.g. astroml", "Nom du dépôt, par ex. astroml"),
    ("Your images", "Vos images"),
    ("Added images appear in the CANFAR Images list, in Find images by package, and in the launch form.", "Les images ajoutées apparaissent dans la liste Images CANFAR, dans Trouver des images par paquet et dans le formulaire de lancement."),
    ("Registry search", "Recherche dans le registre"),
    ("Searching the registry…", "Recherche dans le registre…"),
    ("Nothing in the registry matched that.", "Rien dans le registre ne correspond."),
    ("No session-type labels — launch from the Advanced tab", "Aucune étiquette de type de session — lancez depuis l'onglet Avancé"),
    ("Registry search: {}", "Recherche dans le registre : {}"),
    ("{} image found", "{} image trouvée"),
    ("{} images found", "{} images trouvées"),
    ("Your images ({})", "Vos images ({})"),
    ("Removed {}", "{} retirée"),
    ("Added {}", "{} ajoutée"),
    ("Could not save your image list: {}", "Impossible d'enregistrer votre liste d'images : {}"),
    ("No images available",                         "Aucune image disponible"),
    ...
    ("Show or hide recent searches",                "Afficher ou masquer les recherches récentes"),
