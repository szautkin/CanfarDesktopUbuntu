        ...
        ToolDescriptor {
            ...
            input_schema: json!({
                ...
                "properties": {
                    ...
                    "plate": { "type": "boolean", "description": "Compose the publication figure the Export button produces — framed render, WCS caption, colorbar and the metadata footer — instead of the bare render. Defaults to false, which is the render alone, for composing into a document that supplies its own caption." },
